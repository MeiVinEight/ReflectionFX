...
public class SameLocals1StackItemFrame extends StackMapFrame
{
	...
	{
		StackMapSameLocals1StackItemFrame frame = new StackMapSameLocals1StackItemFrame((byte) (StackMapFrameType.STACK_MAP_SAME_LOCALS_1_ITEM_FRAME.getLow() + (this.marker.address - previous)));
