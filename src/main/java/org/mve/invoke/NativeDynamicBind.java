...
public class NativeDynamicBind extends DynamicBind
{
	...
	public void method(MethodKind implementation, MethodKind invocation, int kind)
	{
		...
		this.bytecode.addField(AccessFlag.ACC_PRIVATE | AccessFlag.ACC_STATIC | AccessFlag.ACC_FINAL, name, Generator.getSignature(Method.class));
	...
	public void construct(MethodKind implementation, MethodKind invocation)
	{
		...
		this.bytecode.addField(AccessFlag.ACC_PRIVATE | AccessFlag.ACC_STATIC | AccessFlag.ACC_FINAL, name, Generator.getSignature(Constructor.class));
