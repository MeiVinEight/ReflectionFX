...
public class MagicConstructorAccessorGenerator extends ConstructorAccessorGenerator
{
	...
	public void generate()
	{
...

		{
			...
			Class<?> c = Unsafe.unsafe.defineAnonymousClass(this.constructor.getDeclaringClass(), access.toByteArray(), null);
			this.access[1] = Unsafe.unsafe.allocateInstance(c);
		}
	...
	public void postgenerate(Class<?> generated)
	{
		...
		Unsafe.unsafe.putObject(generated, offset, this.access[1]);
	}
}
