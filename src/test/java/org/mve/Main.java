...
public class Main
{
	...
	public static void main(String[] args) throws Throwable
	{
		...
		cw.visit(0x34, Opcodes.ACC_PUBLIC | Opcodes.ACC_SUPER, internal_classloader_name, null, superClass, null);

		{
			MethodVisitor mv = cw.visitMethod(Opcodes.ACC_PUBLIC, "<init>", MethodType.methodType(void.class, ClassLoader.class).toMethodDescriptorString(), null, null);
			mv.visitCode();
			mv.visitVarInsn(Opcodes.ALOAD, 0);
			mv.visitLdcInsn(UUID.randomUUID().toString());
			mv.visitVarInsn(Opcodes.ALOAD, 1);
			mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, getType(ClassLoader.class), "getParent", MethodType.methodType(ClassLoader.class).toMethodDescriptorString(), false);
			mv.visitTypeInsn(Opcodes.CHECKCAST, superClass);
			mv.visitInsn(Opcodes.ACONST_NULL);
			mv.visitMethodInsn(Opcodes.INVOKESPECIAL, superClass, "<init>", MethodType.methodType(void.class, String.class, Class.forName(superClass.replace('/', '.')), Class.forName(new String("jdk.internal.loader.URLClassPath".getBytes()))).toMethodDescriptorString(), false);
			mv.visitVarInsn(Opcodes.ALOAD, 0);
			mv.visitTypeInsn(Opcodes.NEW, getType(ConcurrentHashMap.class));
			mv.visitInsn(Opcodes.DUP);
			mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, getType(ConcurrentHashMap.class), "<init>", "()V", false);
			mv.visitFieldInsn(Opcodes.PUTFIELD, internal_classloader_name, "class", getDescriptor(Map.class));
			mv.visitVarInsn(Opcodes.ALOAD, 1);
			mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, getType(ClassLoader.class), "getParent", MethodType.methodType(ClassLoader.class).toMethodDescriptorString(), false);
			mv.visitVarInsn(Opcodes.ASTORE, 2);
			mv.visitFieldInsn(Opcodes.GETSTATIC, getType(Main.class), "TRUSTED_LOOKUP", getDescriptor(MethodHandles.Lookup.class));
			mv.visitLdcInsn(Type.getType(ClassLoader.class));
			mv.visitLdcInsn("parent");
			mv.visitLdcInsn(Type.getType(ClassLoader.class));
			mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, getType(MethodHandles.Lookup.class), "findSetter", MethodType.methodType(MethodHandle.class, Class.class, String.class, Class.class).toMethodDescriptorString(), false);
			...
			mv.visitVarInsn(Opcodes.ALOAD, 0);
			mv.visitInsn(Opcodes.AASTORE);
			mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, getType(MethodHandle.class), "invoke", MethodType.methodType(Object.class, Object[].class).toMethodDescriptorString(), false);
			mv.visitInsn(Opcodes.POP);
			mv.visitVarInsn(Opcodes.ALOAD, 0);
			mv.visitFieldInsn(Opcodes.GETSTATIC, getType(Main.class), "TRUSTED_LOOKUP", getDescriptor(MethodHandles.Lookup.class));
			mv.visitFieldInsn(Opcodes.GETSTATIC, getType(Main.class), "DELEGATING_CLASS", getDescriptor(Class.class));
			mv.visitFieldInsn(Opcodes.GETSTATIC, getType(Void.class), "TYPE", getDescriptor(Class.class));
			mv.visitLdcInsn(Type.getType(ClassLoader.class));
			mv.visitMethodInsn(Opcodes.INVOKESPECIAL, getType(MethodType.class), "methodType", MethodType.methodType(MethodType.class, Class.class, Class.class).toMethodDescriptorString(), false);
			mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, MethodHandles.Lookup.class.getTypeName().replace('.', '/'), "findConstructor", MethodType.methodType(MethodHandle.class, Class.class, MethodType.class).toMethodDescriptorString(), false);
			mv.visitInsn(Opcodes.ICONST_1);
			...
			mv.visitVarInsn(Opcodes.ALOAD, 1);
			mv.visitInsn(Opcodes.AASTORE);
			mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, MethodHandle.class.getTypeName().replace('.', '/'), "invoke", MethodType.methodType(Object.class, Object[].class).toMethodDescriptorString(), false);
			mv.visitTypeInsn(Opcodes.CHECKCAST, "java/lang/ClassLoader");
			mv.visitFieldInsn(Opcodes.PUTFIELD, internal_classloader_name, "this", "Ljava/lang/ClassLoader;");
